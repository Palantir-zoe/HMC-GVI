...
set.seed(123)
# Covariance matrix is selected via GVI
S=Sigma
R=1000000
burn_in=10000
epsilon = 0.168
...
# 932996 1117359 1184778 1164732 1219571 1297591 
# > summary(R / effectiveSize(fit_MCMC_4)) # Integrated autocorrelation time
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.7707  0.8200  0.8440  0.8640  0.8950  1.0718 
# > summary(1 - rejectionRate(fit_MCMC_4)) # Acceptance rate
# Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
# 0.9859  0.9859  0.9859  0.9859  0.9859  0.9859 
# > samples=fit_MCMC_4
# > autocorrelation <- acf(samples, lag.max = 1, plot = FALSE)$acf[2]
# > autocorrelation
# [1] 0.0100904