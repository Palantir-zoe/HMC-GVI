...
- `gaussian100_matched_hmc_20260627.csv` and
  `gaussian100_matched_hmc_20260627_summary.csv` record the matched
  HMC/HMC-GVI comparison for the 100-dimensional Gaussian target, where both
  main HMC chains use `epsilon=0.16` and `L=10`.
